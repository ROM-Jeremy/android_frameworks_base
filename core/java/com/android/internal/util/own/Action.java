...
public class Action {
    ...
    public static void processActionWithOptions(Context context,
            ...
            if (action == null || action.equals(OwnActionConstants.ACTION_NULL)) {
                return;
            }
            ...
            if (action.equals(OwnActionConstants.ACTION_HOME)) {
                ...
                return;
            } else if (action.equals(OwnActionConstants.ACTION_BACK)) {
                ...
                return;
            } else if (action.equals(OwnActionConstants.ACTION_RECENTS)) {
                if (isKeyguardShowing) {
                    return;
                }
                try {
                ...
                return;
            } else if (action.equals(OwnActionConstants.ACTION_ASSIST)
                    || action.equals(OwnActionConstants.ACTION_KEYGUARD_SEARCH)) {
                ...
                return;
            } else if (action.equals(OwnActionConstants.ACTION_VOICE_SEARCH)) {
                ...
                try {
                    ...
                    Log.e("OwnActions:", "No activity to handle assist long press action.", e);
                }
                return;
            } else if (action.equals(OwnActionConstants.ACTION_VIB)) {
                ...
                return;
            } else if (action.equals(OwnActionConstants.ACTION_SILENT)) {
                AudioManager am = (AudioManager) context.getSystemService(Context.AUDIO_SERVICE);
                if (am != null && ActivityManagerNative.isSystemReady()) {
                ...
                return;
            } else if (action.equals(OwnActionConstants.ACTION_VIB_SILENT)) {
                AudioManager am = (AudioManager) context.getSystemService(Context.AUDIO_SERVICE);
                if (am != null && ActivityManagerNative.isSystemReady()) {
                ...
                return;
            } else if (action.equals(OwnActionConstants.ACTION_CAMERA)) {
                ...
                startActivity(context, intent, barService, isKeyguardShowing);
                return;
            } else if (action.equals(OwnActionConstants.ACTION_MEDIA_PREVIOUS)) {
                dispatchMediaKeyWithWakeLock(KeyEvent.KEYCODE_MEDIA_PREVIOUS, context);
                return;
            } else if (action.equals(OwnActionConstants.ACTION_MEDIA_NEXT)) {
                dispatchMediaKeyWithWakeLock(KeyEvent.KEYCODE_MEDIA_NEXT, context);
                return;
            } else if (action.equals(OwnActionConstants.ACTION_MEDIA_PLAY_PAUSE)) {
                dispatchMediaKeyWithWakeLock(KeyEvent.KEYCODE_MEDIA_PLAY_PAUSE, context);
                return;
            } else if (action.equals(OwnActionConstants.ACTION_WAKE_DEVICE)) {
                ...
                try {
                    ...
                    Log.e("OwnActions:", "URISyntaxException: [" + action + "]");
                    return;
                }
                startActivity(context, intent, barService, isKeyguardShowing);
                return;
    ...
    public static boolean isActionKeyEvent(String action) {
        if (action.equals(OwnActionConstants.ACTION_HOME)
                || action.equals(OwnActionConstants.ACTION_BACK)
                || action.equals(OwnActionConstants.ACTION_SEARCH)
                || action.equals(OwnActionConstants.ACTION_MENU)
                || action.equals(OwnActionConstants.ACTION_MENU_BIG)
                || action.equals(OwnActionConstants.ACTION_NULL)) {
            return true;
        }
        return false;
    }
